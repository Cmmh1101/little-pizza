  ...
  return (
    <div className="w-60 lg:w-64 flex flex-col items-center my-6 group">
      <div className={`w-full h-56 filter group-hover:drop-shadow-2xl transition ease-in duration-500 ${classes.img}`}>
        <Image src={item.image} alt={item.name} width={150} height={150} className="transform  object-none object-left-top scale-90 group-hover:scale-95 transition ease-in duration-500" />
      </div>
      <Link
        href={item.url!}
        target="_blank"
