...
const ContactUsArea = () => {
  return (
    <div className="w-full py-28 pt-48 px-5 flex items-center flex-wrap justify-center flex-col text-white bg-black bg-opacity-80 text-center">
      <h2 className="text-4xl uppercase md:text-6xl font-extrabold mb-5">
        Order Now
      </h2>
      <div className="flex items-center flex-wrap justify-center rounded-2xl overflow-hidden text-white bg-black bg-opacity-80 text-center">
