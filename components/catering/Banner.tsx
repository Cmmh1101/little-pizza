...
const Banner = () => {
  return (
    <div className="w-full mt-36 shadow min-h-[50vh] py-28 px-5 lg:px-40 xl:px-60 flex flex-col items-center justify-center bg-green-600 relative overflow-hidden">
      <h3 className="text-3xl uppercase md:text-5xl text-white font-bold text-center z-10">
        Call and Make Your Catering Order!
        <br />
